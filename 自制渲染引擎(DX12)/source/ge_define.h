...
typedef LARGE_INTEGER BIGINTEGER;
...
typedef DirectX::ResourceUploadBatch DXTKUploadBatch;
...
typedef DXGI_ADAPTER_DESC1   DXGIAdaptDesc;
...
typedef D3D12_RENDER_TARGET_BLEND_DESC     D3DRenderTargetBlendDesc;
...
typedef D3D12_FEATURE_DATA_FEATURE_LEVELS             D3DFeature;
...
#define INT8_MIN -9223372036854775808LL

#define UINT1_MAX 0xff
#define UINT2_MAX 0xffff
#define UINT4_MAX 0xffffffff
#define UINT8_MAX 0xffffffffffffffffLL

#define REAL4_MAX 3.402823466e+38f
#define REAL4_MIN 1.175494351e-38f

#define REAL8_MAX 1.7976931348623158e+308
#define REAL8_MIN 2.2250738585072014e-308

#define REAL4_INFINITE 0x7F800000
#define REAL4_NEG_INF  0xFF800000

#define REAL8_INFINITE 0x7FF0000000000000
#define REAL8_NEG_INF  0xFFF0000000000000
...
#define FORCE_CVT(a, b) b = (decltype(b))a
...
#define MemFill(dest, val, size) memset(dest, val, size)
...
#define IsFinite isfinite //!是否有限数(不是Infinity/NaN)
#define IsNormal isnormal //!是否规范数(不是Infinity/NaN/0,也不是Subnormal(阶码全0))
...
#define ModF modf   //!y为x整数部分,返回x小数部分
